...
import os
deepl_file = '../data/language_analysis/df_localization.csv'
deepl_output_file = '../data/language_analysis/deepL_result.csv'
...
def import_clean_data():
    ...
    df_lang.to_csv('../data/language_analysis/df_lang.csv')
    return df_lang
...
def apply_translation_conditionally_in_chunks(df, chunk_size=200, output_file='../data/language_analysis/deepL_result.csv'):    
    total_rows = len(df)
