...
with individual_tab:
    ...
    performance_data = {
        ...
        'Validation Method': ['Clean validation', ' Potential data leakage', 'Clean validation'],
...
with benchmarks_tab:
    ...
    benchmark_data = {
        ...
        'Status': [' EXCEEDS', ' Leakage concern', ' Clean', ' Clean', 'Official baseline', 'Official baseline']
    }
